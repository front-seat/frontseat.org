...
function FixedSidebar({ main, footer }) {
  return (
    <div className="relative flex-none overflow-hidden bg-gradient-to-r from-gray-700 via-gray-700 to-sky-900 px-6 lg:pointer-events-none lg:fixed lg:inset-0 lg:z-40 lg:flex lg:from-transparent lg:via-transparent lg:to-transparent lg:px-0">
      <div className="relative flex w-full lg:pointer-events-auto lg:mr-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-[32rem] lg:overflow-y-auto lg:overflow-x-hidden lg:bg-gradient-to-r lg:from-gray-700 lg:via-gray-700 lg:to-sky-900 lg:pl-[max(4rem,calc(50%-38rem))]">
